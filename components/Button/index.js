  ...
  if (type === "primary") {
    return (
      <button
        ...
        type="button"
        className={cn(
          "text-sm tablet:text-base p-1 laptop:p-2 m-1 laptop:m-2 rounded-lg transition-all duration-300 ease-out first:ml-0 hover:scale-105 active:scale-100 link bg-btnBG text-btnFG",
