...
const Edit = () => {
  ...
  const [submittedPassword, setSubmittedPassword] = useState(""); // State to store the submitted value

  const handleSubmit = (e) => {
    e.preventDefault(); // Prevent page reload
    setSubmittedPassword(password); // Save the submitted password
  };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
          <div className="bg-white w-full max-w-md rounded-lg shadow-lg p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-blue-500 text-white py-2 px-4 rounded-lg shadow-md font-semibold hover:bg-blue-600 transition duration-300"
              >
                Submit
              </button>
            </form>
